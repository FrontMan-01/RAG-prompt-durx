import json
from eval_pipeline_defense_2 import SignedInstructionEvaluator
from dataset import TEST_CASES

def run_evaluation():
    config_name = "Signed Instruction Protocol"
    ...
    for case in TEST_CASES:
        ...
        out = evaluator.run_pipeline(case["query"], case["context"], config)
        ...
        print(f"   Result: {classification} | Response: {response_text}")
